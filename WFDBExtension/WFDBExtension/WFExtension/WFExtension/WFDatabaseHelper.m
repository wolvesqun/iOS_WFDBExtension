...
+ (void)updateDB1
{
    if (![self tableExists:@"User"]) {
        [self executeUpdate:@"CREATE TABLE User (username text NOT NULL PRIMARY KEY UNIQUE,password text NOT NULL,age integer NOT NULL,male boolean NOT NULL,pdate date)"];
    }
}
